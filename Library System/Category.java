...
public class Category extends JInternalFrame implements ActionListener 
{
	...
	public Category(Connection conn, JFrame getParentFrame) throws SQLException
	{
		...
		lblIcon.setIcon(new ImageIcon("images/category list.gif"));
	...
	ActionListener JBActionListener = new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			if(srcObj=="add")
			{
				JDialog JDAdd = new AddEditCategory(true,JFParentFrame,cnCategory,"");
				JDAdd.show();
			} 
			else if(srcObj=="edit")
			{
				if(total != 0)
				{
					try
					{
						...
						{
							JDialog JDEdit = new AddEditCategory(false,JFParentFrame,cnCategory,"SELECT * FROM tblCategory WHERE CategoryID ='" + JTCategoryTbl.getValueAt(JTCategoryTbl.getSelectedRow(),0) + "'");
							JDEdit.show();
						}
					}
			...
			{
				JDialog JDSearch = new Search(JFParentFrame, "Category");
				JDSearch.show();			
			}
