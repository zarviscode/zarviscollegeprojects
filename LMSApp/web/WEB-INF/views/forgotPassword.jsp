    ...
    <body>
        <div id="main_container">
            ...
            <div class="header">
                ...
                <div class="right_header">Get Your Password | <a href="${pageContext.request.contextPath}/home" class="">Home</a></div>
                <div id="clock_a"></div>
            </div>
                    ...
                    <div class="right_content">
                        ...
                        <div class="form">
                            <div id="status" align="left">
                                <sf:form action="" id="forgotForm" class="niceform" modelAttribute="forgotForm">
