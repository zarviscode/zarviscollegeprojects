    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="panel panel-primary" id="flightPanel">
                <div class="panel panel-heading">Create Flight Entry</div>

                <div class="panel panel-body">

                    <form role="form" id="flightForm">
                        <div class="alert alert-info" id="dbMsg"></div>
                        <div class="form-group col-xs-10" id="lblproviderdiv">
                            <label for="lblprovider" id="lblprovider">Provider</label>
                        ...
                        <div class="form-group col-xs-4" id="lbldeptTimediv">
                            ...
                            <input name ="deptTime" type="text" class="form-control" placeholder="Departure" id="deptTime"/>

                        </div>
                        <div class="form-group col-xs-4" id="lblarrTimediv">
                            <label for="lblarrTime" id="lblarrTime">Arrival Time</label>
                            <input name = "arrTime" type="text" class="form-control" placeholder="Arrival" id="arrTime"/>                              

                        </div>
                        <div class="form-group col-xs-4" id="lbltilldiv">
                            <label for="lbltill" id="lbltill">Available Till</label>
                            <input type="text" class="form-control" placeholder="Availability" name="till" id="till"/>

                        </div>

                        <div class="form-group col-xs-4" id="lblexeSeatsdiv">
                            <label for="lblexeSeats" id="lblexeSeats">No.Of.Seats(EXE)</label>
                            <input type="text" class="form-control" placeholder="Seats(EXE)" name = "exeSeats" id="exeSeats"/>

                        </div>

                        <div class="form-group col-xs-4" id="lblbucSeatsdiv">
                            <label for="lblbucSeats" id="lblbucSeats">No.Of.Seats(BUC)</label>
                            <input type="text" class="form-control" placeholder="Seats(BUC)" name = "bucSeats" id="bucSeats"/>

                        </div>
                        <div class="form-group col-xs-4" id="lbltotalSeatsdiv">
                            <label for="lbltotalSeats" id="lbltotalSeats">Total No.Of.Seats</label>
                            <input type="text" class="form-control" placeholder="Total" id="totalSeats" name="totalSeats" readonly="true"/>

                        </div>

                        <div class="form-group col-xs-6" id="lblpriceExediv">
                            <label for="lblpriceExe" id="lblpriceExe">Price of (Executive Class)</label>
                            <input type="text" class="form-control" placeholder="Price (EXE)" name="priceExe" id="priceExe"/>

                        </div>
                        <div class="form-group col-xs-6" id="lblpriceBucdiv">
                            <label for="lblpriceBuc" id="lblpriceBuc">Price of (Business Class)</label>
                            <input type="text" class="form-control" placeholder="Price (BUC)" id="priceBuc" name="priceBuc"/>
                    ...
                    <div class="form-group col-xs-6" id="btnPanel">
                        <button class="btn btn-success" id="btnAddFlight" data-loading-text="Please wait...">Add Flight</button>                           
