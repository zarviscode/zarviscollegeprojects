...
<script type="text/javascript" src="resources/js/Myriad_Pro_italic_600.font.js"></script>
<script type="text/javascript" src="resources/js/Myriad_Pro_italic_400.font.js"></script>
...
<!-- header -->
		<header>
			<div class="wrapper">
				<h1>
					<a href="index.html" id="logo">Air Lines</a><span id="slogan">Miles Acquisition System</span>
				</h1>
				<div class="right">
					<nav>
						<ul id="top_nav">
							<li><a href="index.html"><img src="resources/images/img1.gif" alt=""></a></li>
							<li><a href="index-4.html"><img src="resources/images/img2.gif" alt=""></a></li>
							<li class="bg_none"><a href="#"><img src="resources/images/img3.gif" alt=""></a></li>
						</ul>
					</nav>
					<nav>
						<ul id="menu">
...
<!-- footer -->
		<footer>
			Website designed by &nbsp; <a href="#" target="_blank" rel="nofollow">Sai Teja InfoTech, Vijayawada.</a><br>
