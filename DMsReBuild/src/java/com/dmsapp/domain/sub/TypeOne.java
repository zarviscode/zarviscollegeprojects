 ...
 * @author Sudarsan
 */
public class TypeOne extends Domain implements java.io.Serializable {

    private String studentId;
    private String surName;
    private String firstName;
    private String interOneMarks;
    ...
    public String getInterOneMarks() {
        return interOneMarks;
    }

    public void setInterOneMarks(String interOneMarks) {
        this.interOneMarks = interOneMarks;
    }
    ...
    public String toString() {
        ...
        toStringBuilder.append("\ninterOneMarks: ");
        toStringBuilder.append(interOneMarks);
        toStringBuilder.append("\nassignmentMarks: ");
